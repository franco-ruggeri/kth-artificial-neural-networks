...
class DeepBeliefNet():
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try:
            ...
            """
            h_probability_given_v, h=self.rbm_stack["vis--hid"].get_h_given_v_dir(vis_trainset)
            ...
            """
            h2_probability_given_v, h2 = self.rbm_stack["hid--pen"].get_h_given_v_dir(h)
            self.rbm_stack["pen+lbl--top"].cd1(np.concatenate((h2,lbl_trainset), axis=1), n_iterations)
