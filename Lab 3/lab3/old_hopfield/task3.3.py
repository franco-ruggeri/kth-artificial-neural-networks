...
p10_recalled, iterations, energy = hn.recall(test_data[-2], method='asynch', check_convergence=True)
...
#
#
# recalled_start, e1 = hn_2.recall(start_state, method='synch', max_iters=200)
#
# plt.plot(e1)
# plt.show()
#
...
# hn_3.weights = Wsym
#
# recalled, e2 = hn_3.recall(start_state, method='synch', max_iters=200)
# plt.plot(e2)
# plt.show()
